...
os.execute('rm -rf Milan.lua') 
os.execute('wget https://raw.githubusercontent.com/MilanuuTEAM/Milanuu/master/Milan.lua') 
dofile('Milan.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/teamMilan/MilanuuFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/teamMilan/MilanuuFiles/master/MilanuuFiles/"..FileName)
if Res == 200 then
